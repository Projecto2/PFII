 ...
 */
@Entity
@Table(name = "seg_perfil_associado", catalog = "sigh_db", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class SegPerfilAssociado implements Serializable {
    ...
    @JoinColumn(name = "id_perfil_filho", referencedColumnName = "pk_id_perfil", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private SegPerfil segPerfil;
    @JoinColumn(name = "id_perfil_pai", referencedColumnName = "pk_id_perfil", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "entidade.SegPerfilAssociado[ segPerfilAssociadoPK=" + segPerfilAssociadoPK + " ]";
    }
