...
@ManagedBean
@SessionScoped
public class AmbFarmProdutoListarBean implements Serializable
{
    @EJB
    ...
    /**
     * Creates a new instance of AmbFarmProdutoListarBean
     */
    public AmbFarmProdutoListarBean()
    {
    }
    
    public static AmbFarmProdutoListarBean getInstanciaBean()
    {
        return (AmbFarmProdutoListarBean) GeradorCodigo.getInstanciaBean("ambFarmProdutoListarBean");
    }
