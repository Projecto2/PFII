...
@ManagedBean
@SessionScoped
public class AmbDiagnosticoBean extends AmbCidHipoteseDiagnosticoAbstract
                                                implements Serializable
{
    ...
    /**
     * Creates a new instance of AmbDiagnosticoBean
     */
    public AmbDiagnosticoBean()
    {
    }
    ...
    public static AmbDiagnosticoBean getInstanciaBean()
    {
        return (AmbDiagnosticoBean) GeradorCodigo.getInstanciaBean("ambDiagnosticoBean");
    }    
