...
@ManagedBean
@SessionScoped
public class FarmProdutoListarBean implements Serializable
{
   @EJB
    ...
    */
   public FarmProdutoListarBean()
   {

   }

   public static FarmProdutoListarBean getInstanciaBean()
   {
      FacesContext context = FacesContext.getCurrentInstance();
      FarmProdutoListarBean farmProdutoListarBean = (FarmProdutoListarBean) context.getELContext().getELResolver().getValue(context.getELContext(), null, "farmProdutoListarBean");

      return farmProdutoListarBean;
   }
