...
@ManagedBean
@SessionScoped
public class FarmStockGeralDetalhadoBean implements Serializable
{
   ...
   /**
    * Creates a new instance of FarmStockGeralDetalhadoBean
    */
   public FarmStockGeralDetalhadoBean()
   {
   }

   public static FarmStockGeralDetalhadoBean getInstanciaBean()
   {
      FacesContext context = FacesContext.getCurrentInstance();
      FarmStockGeralDetalhadoBean farmStockGeralDetalhadoBean
              = (FarmStockGeralDetalhadoBean) context.getELContext().getELResolver().getValue(context.getELContext(),
                      null, "farmStockGeralDetalhadoBean");

      return farmStockGeralDetalhadoBean;
   }
