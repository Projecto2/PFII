...
//@RequestScoped
@SessionScoped
public class AdmsPacienteListagemPagamentoPesquisarBean
{
...
//    private String nomeCompleto;
    ...
    public AdmsPacienteListagemPagamentoPesquisarBean()
    {
    }
    
    public static AdmsPacienteListagemPagamentoPesquisarBean getInstanciaBean()
    {
        FacesContext context = FacesContext.getCurrentInstance();
        AdmsPacienteListagemPagamentoPesquisarBean admsPacienteListagemPagamentoPesquisarBean = 
            (AdmsPacienteListagemPagamentoPesquisarBean) context.getELContext().
            getELResolver().getValue(FacesContext.getCurrentInstance().
            getELContext(), null, "admsPacienteListagemPagamentoPesquisarBean");
        
        return admsPacienteListagemPagamentoPesquisarBean;
    }
