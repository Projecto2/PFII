...
public class AdmsPacienteSolicitacaoPesquisarBean implements Serializable
{
    @EJB
...
//    private String nomeCompleto;
    ...
    public AdmsPacienteSolicitacaoPesquisarBean()
    {
    }
    
    public static AdmsPacienteSolicitacaoPesquisarBean getInstanciaBean()
    {
        FacesContext context = FacesContext.getCurrentInstance();
        AdmsPacienteSolicitacaoPesquisarBean admsPacientePesquisarBean = 
            (AdmsPacienteSolicitacaoPesquisarBean) context.getELContext().
