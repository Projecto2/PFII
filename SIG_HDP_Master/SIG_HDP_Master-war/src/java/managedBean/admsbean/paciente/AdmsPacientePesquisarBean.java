...
public class AdmsPacientePesquisarBean implements Serializable
{
    @EJB
...
//    private Integer quantidadeRegistos = 10;
    ...
    private List<AdmsPaciente> pacientes, pacientesSelecionados;
    
//    private String nomeCompleto;
    
    private Date dataNascimentoInicial, dataNascimentoFinal;

    public AdmsPacientePesquisarBean()
    {
    }
    
    public static AdmsPacientePesquisarBean getInstanciaBean()
    {
        FacesContext context = FacesContext.getCurrentInstance();
        AdmsPacientePesquisarBean admsPacientePesquisarBean = 
            (AdmsPacientePesquisarBean) context.getELContext().
...
//    }    
    public List<AdmsPaciente> getPacientesSelecionados()
    {
        return pacientesSelecionados;
    }

    public void setPacientesSelecionados(List<AdmsPaciente> pacientesSelecionados)
    {
