...
@ManagedBean
@SessionScoped
public class DiagExameRealizadoEcografiaBean implements Serializable
{
    ...
    private RhFuncionario rhFuncionarioExame;
    ...
    public static DiagExameRealizadoEcografiaBean getInstanciaBean()
    {
        FacesContext c = FacesContext.getCurrentInstance();
        return (DiagExameRealizadoEcografiaBean) c.getELContext().getELResolver()
                .getValue(c.getELContext(), null, "diagExameRealizadoEcografiaBean");
    }
    ...
    public void selecionarExameEcografiaRealizar(AdmsServicoSolicitado servicoSolicitadoAux)
    {
    ...
    public void pesquisarExamesRealizados()
    {
               
        itens = new ArrayList<>();
        itens = diagExameRealizadoFacade.findPesquisaExameRealizado(diagExameRealizadoPesquisar, dataInicioPesquisa, dataFimPesquisa);
