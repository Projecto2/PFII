...
@ManagedBean
@SessionScoped
public class InterCidHipoteseDiagnosticoBean extends AmbCidHipoteseDiagnosticoAbstract
                                                implements Serializable
{
     ...
     */
    public InterCidHipoteseDiagnosticoBean()
    {
    }
    ...
    public static InterCidHipoteseDiagnosticoBean getInstanciaBean()
    {
        ...
        return (InterCidHipoteseDiagnosticoBean) c.getELContext().getELResolver()
            .getValue(c.getELContext(), null, "interCidHipoteseDiagnosticoBean");
    }
