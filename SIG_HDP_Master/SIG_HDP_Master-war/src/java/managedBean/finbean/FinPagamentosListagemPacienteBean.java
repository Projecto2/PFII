...
//@ViewScoped
@SessionScoped
public class FinPagamentosListagemPacienteBean implements Serializable
{
     ...
     */
    public FinPagamentosListagemPacienteBean()
    {
    }
    
    
    public static FinPagamentosListagemPacienteBean getInstanciaBean()
    {
        FacesContext context = FacesContext.getCurrentInstance();
        FinPagamentosListagemPacienteBean finPagamentosListagemPacienteBean = 
            (FinPagamentosListagemPacienteBean) context.getELContext().
            getELResolver().getValue(FacesContext.getCurrentInstance().
            getELContext(), null, "finPagamentosListagemPacienteBean");
        
        return finPagamentosListagemPacienteBean;
    }
...
//            pagamentoPesquisar.getFkIdTipoPagamentoSolicitacao().setPkIdTipoPagamentoSolicitacao(null);
    ...
    {        
        ...
        finPagamentoLista = finPagamentoFacade.findPagamento(pagamentoPesquisar, 
            dataInicial, dataFinal, pagamentoViaBanco, finPagamentoConvenio, pacienteApresentarDadosAssociadoPagamento, 100);
...
//        if(quantidadeRegistos == null) quantidadeRegistos = new Integer(0);
    ...
    public void limpar()
    {
        finPagamentoLista = null;
        pagamentoPesquisar = null;
    }
